class Page < ApplicationRecord
  ...
  def generate_domain
    self.domain ||= "#{('a'..'z').to_a.shuffle[0, 10].join}.example.com"
  end

  def create_default_links
    link_data = [
      { title: "Home", url: "https://#{domain}/", order: 0 },
      { title: "Categories", url: "https://#{domain}/categories", order: 1 },
      { title: "Authors", url: "https://#{domain}/authors", order: 2 }
    ]
