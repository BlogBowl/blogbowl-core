class API::Internal::Newsletters::EmailsController < API::Internal::Newsletters::ApplicationController
  ...
  # TODO: PRO
  # before_action :check_is_paying, only: %i[send_email send_test_email]
  ...
  # def check_is_paying
  #   if @workspace.newsletter_free?
  #     render json: { error: "Newsletter is not supported in free plans" }, status: :bad_request
  #   end
  # end
