# Revisions are now created automatically when a post is updated via the API.
# The public V1 revisions namespace has been removed in favor of background revision creation.
#
# module API
#   module V1
